    ...
    def new():
        try:
            ...
            if b == "":
                ...
                cur.execute("insert into orders(Id,name,email,Pid,Pname,QTY,bill,date,Buying_Rate) values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",(row[0],row[1],row[3],pid,enk.get(),b,c,formatted_date,asaa))
